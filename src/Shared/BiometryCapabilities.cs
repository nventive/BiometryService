...
{
	/// <summary>
	/// Initializes a new instance of the <see cref="BiometryCapabilities"/> class.
	/// </summary>
	/// <param name="biometryType"><see cref="BiometryType"/>.</param>
	/// <param name="isEnabled">If biometry is enabled.</param>
	/// <param name="isPasscodeSet">If a passcode is set.</param>
